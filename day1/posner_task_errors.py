...
n_trials = 19  # number of trials
p_valid = 0.8  # probability the cue is valid
fix_dur = 0.5  # time the fixation is displayed
cue_dur = 0.5  # time the cue is displayed
sub_id = "03"  # subject ID
...
for i_trial in trials.index:
    ...
    core.wait(clock.getTime() - fix_dur)
    ...
    core.wait((cue_dur + fix_dur) - clock.getTime())
